...
export const SearchBar = ({ onSearch }) => {
    ...
    return (
        <Tooltip content={componentHelp.header.search} position="bottom">
            <form onSubmit={handleSubmit} className="flex items-center">
                <div className="relative w-full">
                    ...
                    <button
                        type="submit"
                        className="absolute right-0 top-0 h-full px-4 text-sm font-medium text-white bg-blue-700 rounded-r-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
